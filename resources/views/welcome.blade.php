...
<head>
    ...
    <title>Online Restaurant Management</title>
                ...
                <div class="col-xs-12 col-sm-6 dis-table-cell">
                    <div class="section-content">
                        ...
                        <p class="section-content-para">
                            Our Restaurant is the one other restaurant that provide ordering food by online. It is so good for all customer that they don't want go to restaurant and want to eat at home, they just open this website and order it's ok for them.
                        </p>
                        <p class="section-content-para">
                            Our Restaurant made since 2019 so we have fully experience to provide a good service to customer and a lot of customer always excited with our service also. Thank you!
                        </p>
                    </div> 
                </div>
            </div>
    ...
    <div class="container-fluid color-bg">
        <div class="row dis-table">
            ...
            <div class="col-xs-6 col-sm-6 dis-table-cell">
                <div class="section-content">
                    <p>Address: Koh Pich, Diamond Twin Tower, Sopheak Mongkol Rd, Phnom Penh, Cambodia</p>
                    <p>Tel: 0965958893</p>
                    <p>Gmail: online.restaurant@mail.com </p>
                </div>
            </div>
        </div>
